...
public class MainViewModel extends ViewModel {
    ...
    private void loadList() {
        ...
        list.add(new Pedal("Distortion",        "DS-1", R.drawable.ds_1, R.drawable.ds_1_small, 1978, 0));
        ...
        list.add(new Pedal("SUPER OverDrive",   "SD-1", R.drawable.sd_1, R.drawable.sd_1_small, 1981, 0));
        ...
        list.add(new Pedal("Heavy Metal",       "HM-2", R.drawable.hm_2, R.drawable.hm_2_small, 1983, 1992));
        ...
        list.add(new Pedal("SUPER Feedbacker & Distortion", "DF-2", R.drawable.df_2, R.drawable.df_2_small, 1984, 1993));
        ...
        list.add(new Pedal("TURBO OverDrive", "OD-2", R.drawable.od_2, R.drawable.od_2_small, 1985, 1994));
        ...
        list.add(new Pedal("Turbo Distortion", "DS-2", R.drawable.ds_2, R.drawable.ds_2_small, 1987, 0));
        ...
        list.add(new Pedal("Digital Metalizer", "MZ-2", R.drawable.mz_2, R.drawable.mz_2_small, 1987, 1992));
        ...
        list.add(new Pedal("Overdrive/Distortion", "OS-2", R.drawable.os_2, R.drawable.os_2_small, 1990, 0));
        list.add(new Pedal("Metal Zone", "MT-2", R.drawable.mt_2, R.drawable.mt_2_small, 1991, 0));
        ...
        list.add(new Pedal("HYPER Fuzz", "FZ-2", R.drawable.fz_2, R.drawable.fz_2_small, 1993, 1997));
        list.add(new Pedal("DUAL Overdrive", "SD-2", R.drawable.sd_2, R.drawable.sd_2_small, 1993, 1998));
        list.add(new Pedal("HYPER Metal", "HM-3", R.drawable.hm_3, R.drawable.hm_3_small, 1993, 1999));
        ...
        list.add(new Pedal("TURBO OverDrive", "OD-2R", R.drawable.odr_2, R.drawable.odr_2_small, 1994, 1999));
        ...
        list.add(new Pedal("Blues Driver", "BD-2", R.drawable.bd_2, R.drawable.bd_2_small, 1995, 0));
        list.add(new Pedal("Digital Delay", "DD-5", R.drawable.dd_5, R.drawable.dd_5_small, 1995, 2002));
        list.add(new Pedal("Power Driver", "PW-2", R.drawable.pw_2, R.drawable.pw_2_small, 1996, 1997));
        list.add(new Pedal("Bass Synthesizer", "SYB-3", R.drawable.syb_3, R.drawable.syb_3_small, 1996, 2004));
        list.add(new Pedal("Xtortion", "XT-2", R.drawable.xt_2, R.drawable.xt_2_small, 1996, 1998));
        list.add(new Pedal("Fuzz", "FZ-3", R.drawable.fz_3, R.drawable.fz_3_small, 1997, 1999));
        ...
        list.add(new Pedal("OverDrive", "OD-3", R.drawable.odb_3, R.drawable.od_3_small, 1997, 0));
        ...
        list.add(new Pedal("Mega Distortion", "MD-2", R.drawable.md_2, R.drawable.md_2_small, 2001, 0));
        ...
        list.add(new Pedal("Metal Core", "ML-2", R.drawable.ml_2, R.drawable.ml_2_small, 2007, 0));
        list.add(new Pedal("Fuzz", "FZ-5", R.drawable.fz_5, R.drawable.fz_5_small, 2007, 0));
        list.add(new Pedal("Dyna Drive", "DN-2", R.drawable.dn_2, R.drawable.dn_2_small, 2007, 2012));
        ...
        list.add(new Pedal("Power Stack", "ST-2", R.drawable.st_2, R.drawable.st_2_small, 2010, 0));
        list.add(new Pedal("Loop Station", "RC-3", R.drawable.rc_3, R.drawable.rc_3_small, 2011, 0));
        list.add(new Pedal("Combo Drive", "BC-2", R.drawable.bc_2, R.drawable.bc_2_small, 2011, 0));
        ...
        list.add(new Pedal("Adaptive Distortion", "DA-2", R.drawable.da_2, R.drawable.da_2_small, 2013, 2014));
        list.add(new Pedal("Multi Overtone", "MO-2", R.drawable.mo_2, R.drawable.mo_2_small, 2013, 0));
        list.add(new Pedal("OverDrive", "OD-1X", R.drawable.odx_1, R.drawable.odx_1_small, 2014, 0));
        list.add(new Pedal("Distortion", "DS-1X", R.drawable.dsx_1, R.drawable.dsx_1_small, 2014, 0));
        list.add(new Pedal("Blues Driver", "BD-2W", R.drawable.bdw_2, R.drawable.bdw_2_small, 2014, 0));
        list.add(new Pedal("SUPER OverDrive", "SD-1W", R.drawable.sdw_1, R.drawable.sdw_1_small, 2014, 0));
        ...
        list.add(new Pedal("Distortion", "DS-1, 4A", R.drawable.dsa_1, R.drawable.dsa_1_small, 2017, 0));
        list.add(new Pedal("Angry Driver", "JB-2", R.drawable.jb_1, R.drawable.jb_1_small, 2017, 0));
        list.add(new Pedal("Metal Zone", "MT-2W", R.drawable.mt_2w, R.drawable.mt_2w_small, -1, 0));
        ...
        list.add(new Pedal("Loop Station", "RC-3", R.drawable.rc_3, R.drawable.rc_3_small, -1, 0));
